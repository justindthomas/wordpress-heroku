...
<div id="social-icons">
	<div id="social-icons-margins">
        ...
        <a href="http://www.w3.org/html/logo/" target="_blank" title="<?php _e('HTML5, CSS3 and mobile compatible design', 'wplook'); ?>"><img src="<?php echo get_template_directory_uri() ?>/images/icons/html5.png" width="22" height="22" /></a>
